...
# Установка
1. Скачайте обработку **MDDesign.epf** свежей версии со страницы [релизов](https://github.com/crimsongoldteam/md_design/releases).
2. Откройте ее в режиме 1С.Предприятие.
# Использование
![](docs\resources\main-screen.png)

Используйте поле редактора для написания прототипа формы. Описание языка в главе [Синтаксис](#синтаксис).
