...
Элемент_Надпись.Заголовок = "Элемент группы 11";

Элемент_Надпись1 = Элементы.Добавить("Надпись1", Тип("ДекорацияФормы"), Элемент_Группа2);
Элемент_Надпись1.Вид = ВидДекорацииФормы.Надпись;
Элемент_Надпись1.Заголовок = "Элемент группы 12";
...
Элемент_Группа3.Заголовок = "Группа 2";
...
Элемент_Надпись2 = Элементы.Добавить("Надпись2", Тип("ДекорацияФормы"), Элемент_Группа3);
Элемент_Надпись2.Вид = ВидДекорацииФормы.Надпись;
Элемент_Надпись2.Заголовок = "Элемент группы 21";