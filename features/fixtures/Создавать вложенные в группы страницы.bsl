...
Элемент_Страницы = Элементы.Добавить("Страницы", Тип("ГруппаФормы"), Элемент_Группа2);
...
Элемент_Страницы1 = Элементы.Добавить("Страницы1", Тип("ГруппаФормы"), Элемент_Группа3);
