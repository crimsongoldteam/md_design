...
Элемент_ЭлементПослеГруппы = Элементы.Добавить("ЭлементПослеГруппы", Тип("ДекорацияФормы"));
Элемент_ЭлементПослеГруппы.Вид = ВидДекорацииФормы.Надпись;
Элемент_ЭлементПослеГруппы.Заголовок = "Элемент после группы";