...
Элемент_ЭлементВнеГруппы = Элементы.Добавить("ЭлементВнеГруппы", Тип("ДекорацияФормы"));
Элемент_ЭлементВнеГруппы.Вид = ВидДекорацииФормы.Надпись;
Элемент_ЭлементВнеГруппы.Заголовок = "Элемент вне группы";