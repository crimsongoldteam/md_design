...
Процедура ИзменитьРеквизитыФормы(Форма, ОписанияРеквизитов)
	...
	Для Каждого СтрокаРеквизит Из ОписанияРеквизитов Цикл  
		...
		//Иначе  
			ОписаниеТипа = ПолучитьОписаниеТипов(СтрокаРеквизит.Типы);
		//КонецЕсли;
...
Функция ПолучитьОписаниеТипов(СоотвОписаниеТипов)
	...
	Если СоотвОписаниеТипов.Типы.Найти("Строка") <> Неопределено 
		...
		КвалификаторыСтроки = Новый КвалификаторыСтроки(СоотвОписаниеТипов.ДлинаСтроки);
	КонецЕсли;	
	
	Если СоотвОписаниеТипов.Типы.Найти("Число") <> Неопределено Тогда
		КвалификаторыСтроки = Новый КвалификаторыЧисла(СоотвОписаниеТипов.ДлинаЧисла, СоотвОписаниеТипов.ТочностьЧисла);
	КонецЕсли;	
	
	Если СоотвОписаниеТипов.Типы.Найти("Дата") <> Неопределено Тогда
		КвалификаторыДаты = Новый КвалификаторыДаты(СоотвОписаниеТипов.ЧастиДаты);
	КонецЕсли;	
