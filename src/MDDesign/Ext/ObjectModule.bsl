...
Функция ПолучитьОписаниеТипов(СоотвОписаниеТипов)
	...
	Если СоотвОписаниеТипов.Типы.Найти("Число") <> Неопределено Тогда
		КвалификаторыЧисла = Новый КвалификаторыЧисла(СоотвОписаниеТипов.ДлинаЧисла, СоотвОписаниеТипов.ТочностьЧисла);
	КонецЕсли;	
	...
	Если СоотвОписаниеТипов.Типы.Найти("Дата") <> Неопределено Тогда
		КвалификаторыДаты = Новый КвалификаторыДаты(ЧастиДаты[СоотвОписаниеТипов.ЧастиДаты]);
	КонецЕсли;	
