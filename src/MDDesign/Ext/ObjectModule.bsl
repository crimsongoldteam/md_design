...
Функция ПолучитьОписаниеТипов(СоотвОписаниеТипов)
	...
	Если СоотвОписаниеТипов.Типы.Найти("Дата") <> Неопределено Тогда
		ЧастиДаты = ?(СоотвОписаниеТипов.ЧастиДаты = Неопределено, ЧастиДаты.ДатаВремя, ЧастиДаты[СоотвОписаниеТипов.ЧастиДаты]);  

		КвалификаторыДаты = Новый КвалификаторыДаты(ЧастиДаты);
	КонецЕсли;	
