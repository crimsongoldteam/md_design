...
&НаКлиенте
Функция СоздатьПараметрыВыполнения(Форма, ИмяРеквизитаHTML, Версия) Экспорт
	Результат = Новый Структура;                         
	
	Результат.Вставить("ИмяРеквизитаHTML", ИмяРеквизитаHTML);
	Результат.Вставить("Форма", Форма);

	РабочийКаталог = СлужебныеФункции().ОбъединитьПути(
		РабочийКаталогДанныхПользователя(),
		"md_design",
		Версия);
	Результат.Вставить("РабочийКаталог", РабочийКаталог);
	
	Результат.Вставить("ИмяФайлаIndex", СлужебныеФункции().ОбъединитьПути(Результат.РабочийКаталог, "index.html"));
	
	Результат.Вставить("ИмяФайлаАрхива", СлужебныеФункции().ОбъединитьПути(Результат.РабочийКаталог, "js.zip"));
