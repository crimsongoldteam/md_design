...
Функция ПолучитьОписаниеФлажка(Родитель) 
	...
	Результат.Вставить("ОписаниеТипов", ПолучитьОписаниеТипов("Булево"));	
...
Функция ОпределитьТипПоСодержанию(Значение) 
	...
	ЭтоЧисло = ЭтоЧисло(Значение); 
	Если ЭтоЧисло Тогда
		ОписаниеТипов.Типы.Добавить("Число");
		ОписаниеТипов.ДлинаЧисла = 15;
		ОписаниеТипов.ТочностьЧисла = ПолучитьТочностьЧисла(Значение);
		Возврат ОписаниеТипов;
	КонецЕсли;
	
	ЭтоДатаВремя = ЭтоДатаВремя(Значение);
...
&НаКлиенте
Функция ЭтоДатаВремя(Знач СтрокаДатаВремя)
...
&НаКлиенте
Функция ЭтоВремя(Знач СтрокаВремя)
	Если СтрокаВремя = "0:00"
		ИЛИ СтрокаВремя = "00:00" 
		ИЛИ СтрокаВремя = "0:00:00"
		ИЛИ СтрокаВремя = "00:00:00"  Тогда
		Возврат Истина;
	КонецЕсли;
	
	Если СтрокаВремя = "00:00:00" Тогда
		Возврат Истина;
	КонецЕсли;
...
&НаКлиенте
Функция ПолучитьТочностьЧисла(Знач Значение)
