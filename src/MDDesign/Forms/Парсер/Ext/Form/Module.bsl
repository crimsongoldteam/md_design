...
Процедура ПарсингДобавляемыхГрупп(ПараметрыВыполнения, ТекущиеГруппы, ТекстГруппа, ПрошлаяГруппа)
	...
	ДобавляемыеГруппыNew = ПолучитьДобавляемыеГруппы(ТекстГруппа);
	
	Если ДобавляемыеГруппыNew.Количество() = 0 Тогда
...
//	
	...
	Для Сч = 0 По ДобавляемыеГруппыNew.ВГраница() Цикл
		ДобавляемаяГруппа = ДобавляемыеГруппыNew[Сч];
