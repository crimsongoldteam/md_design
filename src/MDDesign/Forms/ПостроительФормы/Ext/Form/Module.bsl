...
//&НаКлиенте
//Процедура Построить(Форма, ГруппаРодитель, ОписаниеГруппы, ОписанияРеквизитов) Экспорт 
//	ПостроитьНаСервере(ОписаниеГруппы, ОписанияРеквизитов);
//КонецПроцедуры

//&НаСервере
//Процедура ПостроитьНаСервере( Знач ОписаниеГруппы, Знач ОписанияРеквизитов) 
...
//		ДобавитьКолонкуТаблицы(ПараметрыВыполнения, ТекРодитель, ИмяРеквизитаТаблица, Колонка);
//	КонецЕсли;
//	
...
//&НаСервере
//Процедура ДобавитьКолонкуТаблицы(ПараметрыВыполнения, Знач ЭлементРодитель, ИмяРеквизитаТаблица, Колонка)
//	ТекРодитель = ЭлементРодитель;
//	Форма = ПараметрыВыполнения.Форма;
//	ОписанияРеквизитов = ПараметрыВыполнения.ОписанияРеквизитов;
//	
