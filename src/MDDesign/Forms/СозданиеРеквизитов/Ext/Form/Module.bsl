...
Функция ПолучитьРеквизитыФормыТаблица(ОписанияРеквизитов, СтрокаРеквизит, ИмяРеквизита) 
	Если СтрокаРеквизит.ТипРеквизита = "Таблица" Тогда       
		Возврат ПолучитьОписаниеРеквизита(ИмяРеквизита, "ТаблицаЗначений");
	КонецЕсли;

	Если СтрокаРеквизит.ТипРеквизита = "Дерево" Тогда     
		Возврат ПолучитьОписаниеРеквизита(ИмяРеквизита, "ДеревоЗначений");
	КонецЕсли;
	...
	ОписаниеРеквизита = ПолучитьОписаниеРеквизита(ИмяРеквизита, ТипРеквизита);
