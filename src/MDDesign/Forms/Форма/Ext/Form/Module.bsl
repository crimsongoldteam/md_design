...
Функция Парсинг()
	...
	МассивВертикальныйГрупп = Новый Массив;
	МассивВертикальныйГрупп.Добавить(ДанныеГрупп);
	
	ПараметрыВыполнения = ПолучитьПараметрыВыполненияСтрочныхЭлементов(Неопределено, МассивВертикальныйГрупп);
	
	ПарсингВертикальнойГруппы(ПараметрыВыполнения); 
...
&НаКлиенте
Функция ПарсингВертикальнойГруппы(ПараметрыВыполнения)    
	ВертикальнаяГруппа = ПолучитьТекущийЭлемент(ПараметрыВыполнения);
...
&НаКлиенте
Функция ПарсингМеню(ПараметрыВыполнения, КоманднаяПанельСМеню, Иерархия, Знач Текст) 
