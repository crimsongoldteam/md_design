...
Процедура __РедакторТаблицы(Команда)
	ОткрытьФорму(__ИдентификаторОбработки + ".Форма.ФормаРедактированияТаблицы", , ЭтаФорма, , , ,);
КонецПроцедуры
...
Функция ПарсингОднострочнойГруппы(ПараметрыВыполнения)
	...
	ПараметрыВыполненияОднострочнаяГруппа = ПолучитьПараметрыВыполненияСтрочныхЭлементов(ОднострочнаяГруппа, ОднострочнаяГруппа.ЭлементыПарсинг);
...
Процедура ПарсингПоляВводаМодификаторы(Модификаторы, ЭлементДанных)
	...
	Для СчКлюча = 1 По СтрДлина(Модификаторы) Цикл
		...
		Если КлючСвойств = "v" или КлючСвойств = "?" Тогда
...
Процедура ФорматироватьПолеВвода(ПараметрыВыполнения, ЭлементДанных, Выполнена)
	...
	СвойстваПоляВвода = "";   
	ФорматироватьДобавитьСвойство(СвойстваПоляВвода, ЭлементДанных.НаборСвойств, "КнопкаВыпадающегоСписка", "?");
