...
// Соответствие, содержащие доступные свойства по типам
&НаКлиенте
Перем мСущствующиеСвойства;
...
&НаКлиенте
Процедура __ДобавитьЦвет(Команда)  
...
&НаКлиенте
Процедура ВыборЦветаЗавершение(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
	Если РезультатЗакрытия = Неопределено Тогда
		Возврат;
	КонецЕсли;
КонецПроцедуры
