...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Версия = "0.7.1";
...
Процедура ДобавитьКоманднуюПанель(ПараметрыВыполнения, ЭлементДанных, Группа, Выполнена)  
	...
	Если ЭлементДанных.НаборСвойств.Свойство("ГоризонтальноеПоложениеВГруппе")
		И ЭлементДанных.НаборСвойств.ГоризонтальноеПоложениеВГруппе <> "Лево"
		И НЕ ЭлементДанных.НаборСвойств.Свойство("РастягиватьПоГоризонтали") Тогда
...
Процедура УстановитьСвойствоЭлементаНаСервере(ЭлементФормы, ЭлементДанных)
	...
	Для Каждого КлючЗначение Из ЭлементДанных.НаборСвойств Цикл
		...
		Если НЕ ЭлементДанных.ТипыСвойств.Свойство(ИмяСвойства) Тогда
			Сообщить(СтрШаблон("%1 - %2", Тип, ИмяСвойства));
			Продолжить;
		КонецЕсли;
	...
	//КонецЕсли;     
	//
	//Если Свойства.Свойство("ПоложениеВКоманднойПанели") Тогда
	//	ЭлементФормы.ПоложениеВКоманднойПанели = ПоложениеКнопкиВКоманднойПанели[Свойства.ПоложениеВКоманднойПанели];
	//КонецЕсли;     
...
Процедура УстановитьСвойствоЭлементаМодификаторПоляВвода(Свойства, ЭлементФормы)
