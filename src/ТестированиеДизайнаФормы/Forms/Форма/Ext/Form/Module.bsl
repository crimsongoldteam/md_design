...
Процедура ПарсингДобавляемыхГрупп(ТекущиеГруппы, Группа, ПрошлаяГруппа) 
	...
	Если ТекстНачинаетсяС(Группа, "/") Тогда
		ПрошлаяГруппа.Добавить(Группа);
		ТекущиеГруппы.Добавить(ЗначениеВМассиве(Группа));
		Возврат;
	КонецЕсли;
...
Процедура ПарсингПоляВвода(ПараметрыВыполнения, Родитель, Знач Текст, Выполнена) 
	...
	НовыйЭлемент.Свойства.Заголовок = ЗаголовокЭлемента;
...
Процедура ФорматироватьПолеВвода(ПараметрыВыполнения, ЭлементДанных, Выполнена)
	...
	ЗаголовокЭлемента = ЭлементДанных.Свойства.Заголовок + ": ";
